      ...
      <div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
        <header class="demo-drawer-header">
          ...
          <div class="demo-avatar-dropdown">
            <span><?php echo "<h1>".$_SESSION["username"]."</h2>"; ?></span>
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
          ...
          <a class="mdl-navigation__link" href="view_report.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">inbox</i>ViewReport</a>

          <a class="mdl-navigation__link" href="/final_version/employee.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">delete</i>View Employee</a>
          ...
          <a class="mdl-navigation__link" href="/final_version/view_available_emp.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">forum</i>Update New Field</a>
