    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<h2><b>Update the Employee Details of New Field</b></h2>
					</div>
                </div>
            </div>
                    ...
                    <?php while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href='emp_update_new_field.php?view_emp_id=<?php echo $row['emp_id']?>' data-toggle='modal'  id="<?php echo $row['emp_id']; ?>" class='btn btn-primary left-margin '>
