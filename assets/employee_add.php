<?php
    ...
    if(isset($_POST['add'])){
        ...
        if (mysqli_num_rows($r) > 0)   {
            ...
            echo "<script>alert('already exixts!'); location.href='../employee.php';</script>";
        } else {
        ...
        $query3="INSERT INTO emp_role(emp_id,role_id) VALUES('$emp_id','$role_id' )";
        ...
        $query6="INSERT INTO emp_title(emp_id,title_id) VALUES('$emp_id','$title_id' )";
       ...
       session_start();
        ...
        $employee_id=$_SESSION["username"];
         ...
         $query_branch="SELECT branch_id from emp_branch_department where emp_id='$employee_id'";
         $branch_result=mysqli_query($db,$query_branch);
        ...
        echo($branch_id);        
         ...
         $query13="INSERT INTO emp_branch_department(branch_id,dept_id,emp_id) VALUES('$branch_id','$dept_id','$emp_id' )";
