<?php
    ...
    if(isset($_POST['add'])){
        ...
        $q="select * from sm_details where branch_id='$branch_id'";
        $r=mysqli_query($db,$q);
        
        if (mysqli_num_rows($r) > 0)   {
                
            echo "<script>alert('already that branch has second Maneger'); location.href='../second.php';</script>";
        } else {
        ...
        $query3="INSERT INTO emp_role(emp_id,role_id) VALUES('$emp_id','3' )";
